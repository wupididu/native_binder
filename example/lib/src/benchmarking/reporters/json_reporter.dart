...
class JsonReporter {
  ...
  static TimingStatistics _parseStats(Map<String, dynamic> json) {
    return TimingStatistics(
      ...
      p99_9: (json['p99_9'] as num?)?.toDouble() ?? 0,
      coefficientOfVariation: (json['coefficientOfVariation'] as num).toDouble(),
      skewness: (json['skewness'] as num?)?.toDouble() ?? 0,
      kurtosis: (json['kurtosis'] as num?)?.toDouble() ?? 0,
      interquartileRange: (json['interquartileRange'] as num?)?.toDouble() ?? 0,
