...
class CsvReporter {
  ...
  static String _buildHeaderRow() {
    return [
      ...
      'NB_Total_IQR',
      'MC_Total_IQR',
      'NB_Total_OutlierCount',
      'MC_Total_OutlierCount',
  ...
  static String _buildDataRow(BenchmarkResult result) {
    return [
      ...
      result.nativeBinderTotal.p10.toStringAsFixed(2),
      result.methodChannelTotal.p10.toStringAsFixed(2),
      result.nativeBinderTotal.p25.toStringAsFixed(2),
      result.methodChannelTotal.p25.toStringAsFixed(2),
      result.nativeBinderTotal.p50.toStringAsFixed(2),
      result.methodChannelTotal.p50.toStringAsFixed(2),
      result.nativeBinderTotal.p75.toStringAsFixed(2),
      result.methodChannelTotal.p75.toStringAsFixed(2),
      result.nativeBinderTotal.p90.toStringAsFixed(2),
      result.methodChannelTotal.p90.toStringAsFixed(2),
      ...
      result.nativeBinderTotal.p99_9.toStringAsFixed(2),
      result.methodChannelTotal.p99_9.toStringAsFixed(2),
      ...
      result.nativeBinderTotal.skewness.toStringAsFixed(4),
      result.methodChannelTotal.skewness.toStringAsFixed(4),
      result.nativeBinderTotal.kurtosis.toStringAsFixed(4),
      result.methodChannelTotal.kurtosis.toStringAsFixed(4),
      result.nativeBinderTotal.interquartileRange.toStringAsFixed(2),
      result.methodChannelTotal.interquartileRange.toStringAsFixed(2),
      result.nativeBinderTotal.outlierCount.toString(),
      result.methodChannelTotal.outlierCount.toString(),
      // NativeBinder Breakdown
